    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          aws_ssm_parameter.aws_secret_key.arn
        ]
      }
    ]
  })
...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    ...
    secrets = [
      { name = "AWS_ACCESS_KEY_ID", valueFrom = aws_ssm_parameter.aws_access_key.arn },
      { name = "AWS_SECRET_ACCESS_KEY", valueFrom = aws_ssm_parameter.aws_secret_key.arn }
    ]
    logConfiguration = {
      logDriver = "awslogs"
      options = {
